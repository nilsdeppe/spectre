...
template <typename T>
void CylindricalFlatEndcap::operator()(
...
template <typename T>
void CylindricalFlatEndcap::jacobian(
    const gsl::not_null<
...
#define INSTANTIATE_NOT_NULL(_, data)                                     \
  template void CylindricalFlatEndcap::operator()(                        \
...
#define INSTANTIATE_JACOBIAN_NOT_NULL(_, data)                                \
  template void CylindricalFlatEndcap::jacobian(                              \
      gsl::not_null<                                                          \
