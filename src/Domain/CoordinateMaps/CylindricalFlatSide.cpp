...
template <typename T>
void CylindricalFlatSide::operator()(
...
template <typename T>
void CylindricalFlatSide::jacobian(
    const gsl::not_null<
...
#define INSTANTIATE_NOT_NULL(_, data)                                     \
  template void CylindricalFlatSide::operator()(                          \
...
#define INSTANTIATE_JACOBIAN_NOT_NULL(_, data)                                \
  template void CylindricalFlatSide::jacobian(                                \
      gsl::not_null<                                                          \
