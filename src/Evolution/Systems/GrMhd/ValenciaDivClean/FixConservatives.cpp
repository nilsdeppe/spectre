...
bool FixConservatives::operator()(
  ...
  for (size_t s = 0; s < size; s++) {
    ...
    if (s_tilde_squared > one_minus_safety_factor_for_momentum_density_ *
      ...
      //   10 * W_{lower_bound} brackets the root and then use that as the upper
      //   bound. This reduces the number of iterations for the TOMS748
      //   algorithm to converge to less than 10.
