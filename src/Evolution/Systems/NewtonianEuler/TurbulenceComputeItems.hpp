...
void mach(gsl::not_null<Scalar<DataType>*> result,
...
/// \see NewtonianEuler::mach
///
/// Can be retrieved using `NewtonianEuler::Tags::Mach`
template <typename DataType, size_t Dim, typename Fr = Frame::Inertial>
struct MachCompute : Mach<DataType>, db::ComputeTag {
  using base = Mach<DataType>;
  ...
  static constexpr auto function = static_cast<void (*)(
      ...
      const Scalar<DataType>&)>(&mach<DataType, Dim, Fr>);
};
