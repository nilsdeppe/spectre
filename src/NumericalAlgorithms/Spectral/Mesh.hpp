 ...
 * of grid points/extents must be fewer than 128 per dimension.
 *
...
class Mesh {
 ...
 private:
  ...
  std::array<uint8_t, 6> bit_field_{
      0, 0, 0,  // end of extents
      0,        // dim 0 {basis, quadrature}
      0,        // dim 1 {basis, quadrature}
      0         // dim 2 {basis, quadrature}
  };
};
