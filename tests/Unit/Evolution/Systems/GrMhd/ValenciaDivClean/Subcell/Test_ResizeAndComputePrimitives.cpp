...
void test(const gsl::not_null<std::mt19937*> gen,
  ...
  grmhd::ValenciaDivClean::PrimitiveFromConservative<recovery_schemes>::apply(
      make_not_null(&get<hydro::Tags::RestMassDensity<DataVector>>(prim_vars)),
      make_not_null(
          &get<hydro::Tags::SpecificInternalEnergy<DataVector>>(prim_vars)),
      make_not_null(
          &get<hydro::Tags::SpatialVelocity<DataVector, 3>>(prim_vars)),
      make_not_null(&get<hydro::Tags::MagneticField<DataVector, 3>>(prim_vars)),
      make_not_null(
      ...
      make_not_null(&get<hydro::Tags::SpecificEnthalpy<DataVector>>(prim_vars)),
